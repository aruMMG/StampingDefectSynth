...
def scratch(mat_nodes, TexCoord_node, mat_link, bsdf2_output):
    pass
def material1(tex_path, tex_idx):
...
#    randomiseMapping(Mapping1_node)
    ...
    ImgTex_node.image = bpy.data.images.load('/home/aru/run6/40/'+tex_base[tex_idx])
...
#    addBackground()
    ...
    tex_path = tex_file
    tex_idx = random.randint(0,1)
    mat = material1(tex_path,tex_idx)
    # pdb.set_trace()
...
# File path
    ...
    # material1(object_name, tex_path, mats_name    
    bpy.context.active_object.data.materials.clear()
    mat2 = material1(tex_file2, tex_idx)
    # Subdivide
    deactivate_select()
    ## Rending
