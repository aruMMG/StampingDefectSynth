...
#    randomiseMapping(Mapping1_node)
    ...
    Mapping1_node.inputs[2].default_value = (0, math.radians(random.uniform(0,90)),0)
    #Chocofor1 for metal color
    ImgTex_node = mat_nodes.new('ShaderNodeTexImage')
    ImgTex_node.location = (-1200, -400)
    ImgTex_node.image = bpy.data.images.load('/home/aru/phd/objective2/blender/blendFile/texture/chocofur/tex.jpg')
...
#    MappingMixShader_node.inputs[3].default_value = (0.001, 0.001, 0.001)
    ...
    ImgTexToMixShader_node.image = bpy.data.images.load('/home/aru/phd/objective2/blender/blendFile/texture/chocofur/Chocofur_Chocofur_Metal_Solid_04/maps/Chocofur_Metal_Solid_04_diff.jpg')
...
#    sc_mix_node.use_clamp = True
    ...
    ImgTexImperfection_node.image = bpy.data.images.load('/home/aru/phd/objective2/blender/blendFile/texture/imperfection_0002_2k_wvEb3Q/imperfection_0002_color_2k.jpg')
    ...
    imperfection_math_node.inputs[1].default_value = random.uniform(7,15)
...
def backgroundmat():
    ...
    ImgTex_node = mat_nodes.new('ShaderNodeTexImage')
    ImgTex_node.location = (-1200, -400)
    ImgTex_node.image = bpy.data.images.load('/home/aru/phd/objective2/blender/blendFile/texture/texturePhotos/texture/background_safe_sample/IMG_4761.JPG')
...
if __name__=="__main__":
    ...
    obj_file = "/home/aru/run_p2/obj1.obj"
#    obj_file = "/home/aru/phd/objective2/blender/blendFile/geometry/objFilesRunInBeast/obj302.obj"
    tex_file = "/home/aru/run6/120/texture/1/tex6_l.png"
    save_file = "/home/aru/run_p2/img"
    csv_path = "/home/aru/phd/objective2/p2/f6/"
    
#    obj_file="/home/aru/phd/objective2/blender/blendFile/python/python/python/python/createOBJ/objFile/obj11.obj"
#    tex_file="/home/aru/phd/objective2/blender/blendFile/texture/4NormalMapR.png"
#    save_file="/home/aru/phd/objective2/blender/blendFile/texture/"
    deleteAllObjects()
#    addBackground()
    addBackgroundObj()
    b_mat = backgroundmat()
    ...
    x_location = random.uniform(-0.02,0.02)
    y_location = random.uniform(-0.02,0.02)
