...
def createObj(args, coordDF, nodesTOcoord_dict, coordTOnodes_dict, nodes_DynaToObj_dict, nodes_ObjToDyna_dict, elemDF, defect_data, objNum, texRatio, texSize, one_defect=True):
    ...
    for key in defect_clusters_dict:
        ...
        coordArr, one_cluster_df, noDefect_elem_dict = addNoDefect(args, coordArr, coordDF, noDefect_elem_dict, defect_elem_dict, one_cluster_df, coordTOnodes_dict, nodesTOcoord_dict, nodes_ObjToDyna_dict, key, count=count)
...
if __name__=="__main__":
    ...
    parser.add_argument('--double', action='store_true', help='Is the defect cove full length of part.')
